    ...
    public function defineGeneralSchema(): array
    {
        return [
            ...
            SchemaHelper::textareaField([
                'label' => Craft::t('formie-paragraph-field', 'Paragraph Content'),
                'help' => Craft::t('formie-paragraph-field', 'The content to be displayed. Line breaks will be converted to <br> tags.'),
                'name' => 'paragraphContent',
                'validation' => 'required',
                'required' => true,
                'rows' => 4,
            ...
            SchemaHelper::selectField([
                'label' => Craft::t('formie-paragraph-field', 'Text Size'),
                'help' => Craft::t('formie-paragraph-field', 'Choose the size for the paragraph text.'),
                'name' => 'textSize',
