...
If you discover a security vulnerability in Formie Paragraph Field, please report it privately. **Do not open a public GitHub issue** — public disclosure before a fix is available puts other users at risk.

### Preferred: GitHub private advisory

[Open a private security advisory](https://github.com/LindemannRock/craft-formie-paragraph-field/security/advisories/new). This routes the report directly to maintainers with no public visibility.
...
- XSS or HTML injection in rendered paragraph content
- Input validation bypass on submitted content
